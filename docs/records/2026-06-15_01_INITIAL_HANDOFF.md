# receipt-ocr 初期 Handoff

- 更新日: 2026-06-15（内容上の基準日）
- Gitで確認できる初回記録: 2026-06-20

> この文書は、同日の実機アップロード成功前の状態を中心に記録している。
> 正確な更新時刻は、Git履歴が2026-06-20の初回コミットから始まるため復元できない。
> 後続の記録は `docs/records/2026-06-15_02_HANDOFF.md` を参照すること。
...
```text
docs/records/2026-06-15_02_HANDOFF.md
```
